...
var AetherUpload = {
    ...
    upload: function (name) {
        ...
        this.resourceDom = this.wrapperDom.find('#'+name+'-file'),
            ...
            this.storageHost = $('#'+name+'-storage-host').length ? $('#'+name+'-storage-host').val() : '';
 ...
 * resource 文件对象
 */
function aetherupload(resource, name) {
    ...
    newInstance.savedPathDom = newInstance.wrapperDom.find("#"+name+"-progressbar"); //资源储存地址所在节点的默认值
